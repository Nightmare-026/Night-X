...
// Dynamic SSR-safe imports for tools to prevent Browser-API (DOMMatrix, etc) errors during hydration
const ImageCompressor = dynamic(() => import("@/components/tools/ImageCompressor").then(m => m.ImageCompressor), { ssr: false });
const ImageConverter = dynamic(() => import("@/components/tools/ImageConverter").then(m => m.ImageConverter), { ssr: false });
const ImageToPDF = dynamic(() => import("@/components/tools/ImageToPDF").then(m => m.ImageToPDF), { ssr: false });
const QRBuilder = dynamic(() => import("@/components/tools/QRBuilder").then(m => m.QRBuilder), { ssr: false });
const PasswordGenerator = dynamic(() => import("@/components/tools/PasswordGenerator").then(m => m.PasswordGenerator), { ssr: false });
const JSONPrettier = dynamic(() => import("@/components/tools/JSONPrettier").then(m => m.JSONPrettier), { ssr: false });
const Base64Master = dynamic(() => import("@/components/tools/Base64Master").then(m => m.Base64Master), { ssr: false });
const MarkdownLive = dynamic(() => import("@/components/tools/MarkdownLive").then(m => m.MarkdownLive), { ssr: false });
const VideoShrinker = dynamic(() => import("@/components/tools/VideoShrinker").then(m => m.VideoShrinker), { ssr: false });
const VideoToGIF = dynamic(() => import("@/components/tools/VideoToGIF").then(m => m.VideoToGIF), { ssr: false });
const PDFToImage = dynamic(() => import("@/components/tools/PDFToImage").then(m => m.PDFToImage), { ssr: false });
const URLCoder = dynamic(() => import("@/components/tools/URLCoder").then(m => m.URLCoder), { ssr: false });
const UnitConverter = dynamic(() => import("@/components/tools/UnitConverter").then(m => m.UnitConverter), { ssr: false });
const WordCounter = dynamic(() => import("@/components/tools/WordCounter").then(m => m.WordCounter), { ssr: false });
const DuplicateRemover = dynamic(() => import("@/components/tools/DuplicateRemover").then(m => m.DuplicateRemover), { ssr: false });
const LoremIpsum = dynamic(() => import("@/components/tools/LoremIpsum").then(m => m.LoremIpsum), { ssr: false });
const ColorPalette = dynamic(() => import("@/components/tools/ColorPalette").then(m => m.ColorPalette), { ssr: false });
const ScientificCalculator = dynamic(() => import("@/components/tools/ScientificCalculator").then(m => m.ScientificCalculator), { ssr: false });
const AgeCalculator = dynamic(() => import("@/components/tools/AgeCalculator").then(m => m.AgeCalculator), { ssr: false });
const EMICalculator = dynamic(() => import("@/components/tools/EMICalculator").then(m => m.EMICalculator), { ssr: false });
const BaseConverter = dynamic(() => import("@/components/tools/BaseConverter").then(m => m.BaseConverter), { ssr: false });
const DiscountCalculator = dynamic(() => import("@/components/tools/DiscountCalculator").then(m => m.DiscountCalculator), { ssr: false });
const CGPACalculator = dynamic(() => import("@/components/tools/CGPACalculator").then(m => m.CGPACalculator), { ssr: false });
const CaseConverter = dynamic(() => import("@/components/tools/CaseConverter").then(m => m.CaseConverter), { ssr: false });
const TextEncryptor = dynamic(() => import("@/components/tools/TextEncryptor").then(m => m.TextEncryptor), { ssr: false });
