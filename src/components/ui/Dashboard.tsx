      ...
      {isOpen && (
        <>
          ...
          {!loading && !user ? (
            ...
            /* ─── PROFILE MODAL ─── */
            <div className="fixed inset-0 z-[101] flex items-center justify-center p-0 sm:p-6 pointer-events-none">
              <motion.div
                variants={containerVariants}
                initial="hidden"
                animate="visible"
                exit="exit"
                className="pointer-events-auto h-full w-full sm:h-[90vh] md:max-h-[85vh] sm:w-[90vw] md:max-w-4xl bg-night-black/95 sm:rounded-[3rem] border-white/[0.08] sm:border flex flex-col shadow-[0_50px_100px_rgba(0,0,0,0.8)] matte-grain overflow-hidden relative"
              >
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-7 h-full">
                          <motion.div variants={itemVariants} className="h-full">
                            <TiltCard color="#ffffff" className="p-8 sm:p-10 rounded-[3rem] h-full shadow-2xl overflow-hidden group">
                              ...
                              <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 mb-10 text-center sm:text-left relative z-10">
                                        ...
                                        onChange={async (e) => {
                                          ...
                                          if (file && auth.currentUser) {
                                            try {
                                              ...
                                              alert("Failed to upload avatar. Check Firebase Storage rules.");
                                            }
                                          }
                                        }}
                                      />
                ...
                <motion.div variants={itemVariants}>
                  <TiltCard color="#10b981" className="mx-8 sm:mx-10 mb-8 sm:mb-10 rounded-[2rem]">
                    <div className="p-8 bg-white/[0.02] backdrop-blur-3xl relative z-10">
